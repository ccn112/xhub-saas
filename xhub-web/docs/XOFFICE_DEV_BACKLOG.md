> **Bản nhân bản (2026-08-04) từ `docs/DEV_BACKLOG.md`** — điểm khởi đầu để chuẩn hoá
> riêng cho X.Office, CHƯA được rút gọn: vẫn còn nguyên nội dung chung + mốc cũ (trước
> khi tách process/DB). Cần dọn bớt phần không thuộc X.Office khi chuẩn hoá.
