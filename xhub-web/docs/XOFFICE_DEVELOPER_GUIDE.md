# X.Office — Developer Guide

> **Bản nhân bản (2026-08-04) từ `docs/DEVELOPER_GUIDE.md`** — điểm khởi đầu để chuẩn hoá
> riêng cho X.Office, CHƯA được rút gọn: vẫn còn nguyên nội dung chung của cả XHub/X.Space/
> X.Office tại thời điểm nhân bản. Cần dọn bớt phần không thuộc X.Office khi chuẩn hoá.
